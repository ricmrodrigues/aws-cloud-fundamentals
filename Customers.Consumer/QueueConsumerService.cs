    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            foreach (var message in response.Messages)
            {
                ...
                ISqsMessage? typedMessage = JsonSerializer.Deserialize(message.Body, type) as ISqsMessage;
                try
                {
                ...
                await _sqs.DeleteMessageAsync(queueUrlResponse.QueueUrl, (string)message.ReceiptHandle, stoppingToken);
            }
